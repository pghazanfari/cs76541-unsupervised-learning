...
The code for this assignment is run as 2 Jupyter notebook (one for each dataset).
It can be downloaded from here: https://github.com/pghazanfari/cs76541-unsupervised-learning
...
* Open either 'heart.ipynb' or 'stroke.ipynb' and run all cells
* Repeat last step for opposing notebook

Note: It may take some time to run the notebooks, but it shouldn't take hours.
